...
{
    /// <summary>
    /// Summary description for CartPageMobileCompatTest
    /// </summary>
    [TestClass]
    public class CartPageMobileCompatTest
    {
        ...
        private By CartProdAmount = By.XPath("/html/body/section/div[1]/div[5]/div[1]/div/div[3]/div[2]/input");
        ...
        private By CartProdAmount2 = By.XPath("/html/body/section/div[1]/div[5]/div[2]/div/div[3]/div[2]/input");
        ...
        private By CartRemoveItem = By.XPath("//*[@class=\"display-only-mobile cart-item-remove js-item-remove\"]");

        [TestInitialize]
        public void TestSetUp()
        {
            _driver = new ChromeDriver();
            _driver.Manage().Window.Size = new Size(334, 750);
        }
